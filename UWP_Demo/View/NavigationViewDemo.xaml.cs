...
using UWP_Demo.View.SongService;
...
{
    ("mymusic", typeof(SongService.UploadSong)),
    ("allmusic", typeof(SongService.AllSong1)),
    ("register", typeof(RegisterPage)),
    ("login", typeof(LoginPage)),
    ("accountInfo", typeof(UserInformation)),
};
